...
const SEED: PlayerSeed[] = [
  ...
  // ================= Growth batch 3 — toward 300 (with birth years) =================

  // ---- Goalkeepers ----
  { id: 'fabien_barthez', name: 'Fabien Barthez', nationality: 'France', positions: ['goalkeeper'], clubs: ['Marseille', 'Monaco', 'Manchester United'], debutYear: 1992, lastYear: 2007, birthYear: 1971, won: 'cl wc eu lg', aliases: ['Barthez'] },
  { id: 'yann_sommer', name: 'Yann Sommer', nationality: 'Switzerland', positions: ['goalkeeper'], clubs: ['Basel', 'Borussia Mönchengladbach', 'Bayern Munich', 'Inter Milan'], debutYear: 2010, birthYear: 1988, won: 'lg', aliases: ['Sommer'] },
  { id: 'jens_lehmann', name: 'Jens Lehmann', nationality: 'Germany', positions: ['goalkeeper'], clubs: ['Schalke 04', 'Borussia Dortmund', 'Arsenal', 'VfB Stuttgart'], debutYear: 1988, lastYear: 2011, birthYear: 1969, won: 'lg', aliases: ['Lehmann'] },

  // ---- Defenders ----
  { id: 'lilian_thuram', name: 'Lilian Thuram', nationality: 'France', positions: ['defender'], clubs: ['Monaco', 'Parma', 'Juventus', 'Barcelona'], debutYear: 1991, lastYear: 2008, birthYear: 1972, won: 'wc eu lg', aliases: ['Thuram'] },
  { id: 'marcel_desailly', name: 'Marcel Desailly', nationality: 'France', positions: ['defender'], clubs: ['Marseille', 'AC Milan', 'Chelsea'], debutYear: 1986, lastYear: 2006, birthYear: 1968, won: 'cl wc eu lg', aliases: ['Desailly'] },
  { id: 'ricardo_carvalho', name: 'Ricardo Carvalho', nationality: 'Portugal', positions: ['defender'], clubs: ['Porto', 'Chelsea', 'Real Madrid', 'Monaco'], debutYear: 2001, lastYear: 2017, birthYear: 1978, won: 'cl lg', aliases: ['Carvalho'] },
  { id: 'branislav_ivanovic', name: 'Branislav Ivanović', nationality: 'Serbia', positions: ['defender'], clubs: ['Chelsea', 'Zenit', 'West Ham United'], debutYear: 2006, lastYear: 2021, birthYear: 1984, won: 'cl lg', aliases: ['Ivanovic'] },
  { id: 'leonardo_bonucci', name: 'Leonardo Bonucci', nationality: 'Italy', positions: ['defender'], clubs: ['Genoa', 'Juventus', 'AC Milan', 'Fenerbahçe'], debutYear: 2005, lastYear: 2024, birthYear: 1987, won: 'eu lg', aliases: ['Bonucci'] },
  { id: 'antonio_rudiger', name: 'Antonio Rüdiger', nationality: 'Germany', positions: ['defender'], clubs: ['VfB Stuttgart', 'Roma', 'Chelsea', 'Real Madrid'], debutYear: 2011, birthYear: 1993, won: 'cl lg', aliases: ['Rudiger'] },
  { id: 'william_saliba', name: 'William Saliba', nationality: 'France', positions: ['defender'], clubs: ['Saint-Étienne', 'Arsenal'], debutYear: 2018, birthYear: 2001, won: '', aliases: ['Saliba'] },
  { id: 'gabriel_magalhaes', name: 'Gabriel Magalhães', nationality: 'Brazil', positions: ['defender'], clubs: ['Lille', 'Arsenal'], debutYear: 2016, birthYear: 1997, won: '', aliases: ['Gabriel', 'Gabriel Magalhaes'] },
  { id: 'eder_militao', name: 'Éder Militão', nationality: 'Brazil', positions: ['defender'], clubs: ['São Paulo', 'Porto', 'Real Madrid'], debutYear: 2017, birthYear: 1998, won: 'cl lg', aliases: ['Militao'] },

  // ---- Midfielders ----
  { id: 'javier_mascherano', name: 'Javier Mascherano', nationality: 'Argentina', positions: ['midfielder', 'defender'], clubs: ['River Plate', 'Liverpool', 'Barcelona'], debutYear: 2003, lastYear: 2020, birthYear: 1984, won: 'cl lg', aliases: ['Mascherano'] },
  { id: 'michael_essien', name: 'Michael Essien', nationality: 'Ghana', positions: ['midfielder'], clubs: ['Lyon', 'Chelsea', 'Real Madrid', 'AC Milan'], debutYear: 2000, lastYear: 2020, birthYear: 1982, won: 'cl lg', aliases: ['Essien'] },
  { id: 'edgar_davids', name: 'Edgar Davids', nationality: 'Netherlands', positions: ['midfielder'], clubs: ['Ajax', 'AC Milan', 'Juventus', 'Inter Milan', 'Tottenham Hotspur'], debutYear: 1991, lastYear: 2014, birthYear: 1973, won: 'cl lg', aliases: ['Davids'] },
  { id: 'fernandinho', name: 'Fernandinho', nationality: 'Brazil', positions: ['midfielder'], clubs: ['Shakhtar Donetsk', 'Manchester City'], debutYear: 2002, birthYear: 1985, won: 'lg' },
  { id: 'granit_xhaka', name: 'Granit Xhaka', nationality: 'Switzerland', positions: ['midfielder'], clubs: ['Basel', 'Borussia Mönchengladbach', 'Arsenal', 'Bayer Leverkusen'], debutYear: 2010, birthYear: 1992, won: 'lg', aliases: ['Xhaka'] },
  { id: 'christian_eriksen', name: 'Christian Eriksen', nationality: 'Denmark', positions: ['midfielder'], clubs: ['Ajax', 'Tottenham Hotspur', 'Inter Milan', 'Brentford', 'Manchester United'], debutYear: 2010, birthYear: 1992, won: 'lg', aliases: ['Eriksen'] },
  { id: 'james_milner', name: 'James Milner', nationality: 'England', positions: ['midfielder'], clubs: ['Leeds United', 'Aston Villa', 'Manchester City', 'Liverpool', 'Brighton'], debutYear: 2002, birthYear: 1986, won: 'cl lg', aliases: ['Milner'] },
  { id: 'jordan_henderson', name: 'Jordan Henderson', nationality: 'England', positions: ['midfielder'], clubs: ['Liverpool', 'Ajax'], debutYear: 2008, birthYear: 1990, won: 'cl lg', aliases: ['Henderson'] },
  { id: 'park_ji_sung', name: 'Park Ji-sung', nationality: 'South Korea', positions: ['midfielder'], clubs: ['PSV', 'Manchester United', 'QPR'], debutYear: 2000, lastYear: 2014, birthYear: 1981, won: 'cl lg', aliases: ['Park'] },
  { id: 'shinji_kagawa', name: 'Shinji Kagawa', nationality: 'Japan', positions: ['midfielder'], clubs: ['Borussia Dortmund', 'Manchester United'], debutYear: 2006, birthYear: 1989, won: 'lg', aliases: ['Kagawa'] },
  { id: 'jay_jay_okocha', name: 'Jay-Jay Okocha', nationality: 'Nigeria', positions: ['midfielder'], clubs: ['Eintracht Frankfurt', 'Paris Saint-Germain', 'Bolton Wanderers'], debutYear: 1992, lastYear: 2008, birthYear: 1973, won: '', aliases: ['Okocha'] },
  { id: 'florent_malouda', name: 'Florent Malouda', nationality: 'France', positions: ['winger', 'midfielder'], clubs: ['Lyon', 'Chelsea'], debutYear: 2000, lastYear: 2018, birthYear: 1980, won: 'cl lg', aliases: ['Malouda'] },
  { id: 'nemanja_matic', name: 'Nemanja Matić', nationality: 'Serbia', positions: ['midfielder'], clubs: ['Chelsea', 'Manchester United', 'Roma'], debutYear: 2009, birthYear: 1988, won: 'lg', aliases: ['Matic'] },
  { id: 'aaron_ramsey', name: 'Aaron Ramsey', nationality: 'Wales', positions: ['midfielder'], clubs: ['Arsenal', 'Juventus', 'Rangers'], debutYear: 2008, birthYear: 1990, won: 'lg', aliases: ['Ramsey'] },
  { id: 'juan_veron', name: 'Juan Sebastián Verón', nationality: 'Argentina', positions: ['midfielder'], clubs: ['Estudiantes', 'Sampdoria', 'Parma', 'Lazio', 'Manchester United', 'Chelsea', 'Inter Milan'], debutYear: 1994, lastYear: 2014, birthYear: 1975, won: 'lg', aliases: ['Veron'] },
  { id: 'enzo_fernandez', name: 'Enzo Fernández', nationality: 'Argentina', positions: ['midfielder'], clubs: ['River Plate', 'Benfica', 'Chelsea'], debutYear: 2019, birthYear: 2001, won: 'wc', aliases: ['Enzo'] },
  { id: 'aurelien_tchouameni', name: 'Aurélien Tchouaméni', nationality: 'France', positions: ['midfielder'], clubs: ['Monaco', 'Real Madrid'], debutYear: 2018, birthYear: 2000, won: 'cl lg', aliases: ['Tchouameni'] },
  { id: 'eduardo_camavinga', name: 'Eduardo Camavinga', nationality: 'France', positions: ['midfielder'], clubs: ['Rennes', 'Real Madrid'], debutYear: 2019, birthYear: 2002, won: 'cl lg', aliases: ['Camavinga'] },
  { id: 'moises_caicedo', name: 'Moisés Caicedo', nationality: 'Ecuador', positions: ['midfielder'], clubs: ['Brighton', 'Chelsea'], debutYear: 2020, birthYear: 2001, won: '', aliases: ['Caicedo'] },
  { id: 'hidetoshi_nakata', name: 'Hidetoshi Nakata', nationality: 'Japan', positions: ['midfielder'], clubs: ['Roma', 'Parma', 'Fiorentina', 'Bologna'], debutYear: 1995, lastYear: 2006, birthYear: 1977, won: 'lg', aliases: ['Nakata'] },

  // ---- Forwards & wingers ----
  { id: 'gianfranco_zola', name: 'Gianfranco Zola', nationality: 'Italy', positions: ['forward'], clubs: ['Napoli', 'Parma', 'Chelsea'], debutYear: 1989, lastYear: 2005, birthYear: 1966, won: 'lg', aliases: ['Zola'] },
  { id: 'paulo_futre', name: 'Paulo Futre', nationality: 'Portugal', positions: ['forward', 'winger'], clubs: ['Sporting CP', 'Porto', 'Atlético Madrid', 'Benfica', 'Marseille', 'AC Milan'], debutYear: 1983, lastYear: 1998, birthYear: 1966, won: 'cl lg', aliases: ['Futre'] },
  { id: 'robbie_fowler', name: 'Robbie Fowler', nationality: 'England', positions: ['striker'], clubs: ['Liverpool', 'Leeds United', 'Manchester City'], debutYear: 1993, lastYear: 2012, birthYear: 1975, won: '', aliases: ['Fowler'] },
  { id: 'dimitar_berbatov', name: 'Dimitar Berbatov', nationality: 'Bulgaria', positions: ['striker', 'forward'], clubs: ['Bayer Leverkusen', 'Tottenham Hotspur', 'Manchester United', 'Fulham', 'Monaco'], debutYear: 2000, lastYear: 2017, birthYear: 1981, won: 'lg', aliases: ['Berbatov'] },
  { id: 'nwankwo_kanu', name: 'Nwankwo Kanu', nationality: 'Nigeria', positions: ['forward', 'striker'], clubs: ['Ajax', 'Inter Milan', 'Arsenal'], debutYear: 1993, lastYear: 2012, birthYear: 1976, won: 'cl lg', aliases: ['Kanu'] },
  { id: 'mario_balotelli', name: 'Mario Balotelli', nationality: 'Italy', positions: ['striker'], clubs: ['Inter Milan', 'Manchester City', 'AC Milan', 'Liverpool', 'Nice', 'Marseille'], debutYear: 2007, birthYear: 1990, won: 'lg', aliases: ['Balotelli'] },
  { id: 'mario_gomez', name: 'Mario Gomez', nationality: 'Germany', positions: ['striker'], clubs: ['VfB Stuttgart', 'Bayern Munich', 'Fiorentina'], debutYear: 2003, lastYear: 2020, birthYear: 1985, won: 'lg', aliases: ['Gomez'] },
  { id: 'dirk_kuyt', name: 'Dirk Kuyt', nationality: 'Netherlands', positions: ['forward'], clubs: ['Feyenoord', 'Liverpool', 'Fenerbahçe'], debutYear: 2003, lastYear: 2017, birthYear: 1980, won: 'lg', aliases: ['Kuyt'] },
  { id: 'hulk', name: 'Hulk', nationality: 'Brazil', positions: ['forward', 'striker'], clubs: ['Porto', 'Zenit'], debutYear: 2005, birthYear: 1986, won: 'lg' },
  { id: 'lorenzo_insigne', name: 'Lorenzo Insigne', nationality: 'Italy', positions: ['forward', 'winger'], clubs: ['Napoli'], debutYear: 2010, birthYear: 1991, won: 'eu', aliases: ['Insigne'] },
  { id: 'dries_mertens', name: 'Dries Mertens', nationality: 'Belgium', positions: ['forward'], clubs: ['PSV', 'Napoli', 'Galatasaray'], debutYear: 2009, birthYear: 1987, won: 'lg', aliases: ['Mertens'] },
  { id: 'roberto_firmino', name: 'Roberto Firmino', nationality: 'Brazil', positions: ['forward', 'striker'], clubs: ['Hoffenheim', 'Liverpool', 'Al Ahli'], debutYear: 2009, birthYear: 1991, won: 'cl lg', aliases: ['Firmino'] },
  { id: 'xherdan_shaqiri', name: 'Xherdan Shaqiri', nationality: 'Switzerland', positions: ['winger', 'forward'], clubs: ['Basel', 'Bayern Munich', 'Inter Milan', 'Liverpool', 'Lyon'], debutYear: 2009, birthYear: 1991, won: 'cl lg', aliases: ['Shaqiri'] },
  { id: 'douglas_costa', name: 'Douglas Costa', nationality: 'Brazil', positions: ['winger'], clubs: ['Shakhtar Donetsk', 'Bayern Munich', 'Juventus'], debutYear: 2008, birthYear: 1990, won: 'lg', aliases: ['Costa'] },
  { id: 'raphinha', name: 'Raphinha', nationality: 'Brazil', positions: ['winger', 'forward'], clubs: ['Rennes', 'Leeds United', 'Barcelona'], debutYear: 2016, birthYear: 1996, won: 'lg' },
  { id: 'cody_gakpo', name: 'Cody Gakpo', nationality: 'Netherlands', positions: ['forward', 'winger'], clubs: ['PSV', 'Liverpool'], debutYear: 2018, birthYear: 1999, won: 'lg', aliases: ['Gakpo'] },
  { id: 'rodrygo', name: 'Rodrygo', nationality: 'Brazil', positions: ['forward', 'winger'], clubs: ['Santos', 'Real Madrid'], debutYear: 2017, birthYear: 2001, won: 'cl lg' },
  { id: 'tim_cahill', name: 'Tim Cahill', nationality: 'Australia', positions: ['midfielder', 'forward'], clubs: ['Everton', 'New York Red Bulls'], debutYear: 1997, lastYear: 2018, birthYear: 1979, won: '', aliases: ['Cahill'] },

  /* ================= Expansion batch — legends ================= */
  { id: 'gordon_banks', name: 'Gordon Banks', nationality: 'England', positions: ['goalkeeper'], clubs: ['Leicester City', 'Stoke City'], debutYear: 1958, lastYear: 1978, birthYear: 1937, won: 'wc' },
  { id: 'peter_shilton', name: 'Peter Shilton', nationality: 'England', positions: ['goalkeeper'], clubs: ['Leicester City', 'Nottingham Forest', 'Southampton', 'Derby County'], debutYear: 1966, lastYear: 1995, birthYear: 1949, won: 'cl lg' },
  { id: 'michel_platini', name: 'Michel Platini', nationality: 'France', positions: ['midfielder'], clubs: ['Nancy', 'Saint-Étienne', 'Juventus'], debutYear: 1972, lastYear: 1987, birthYear: 1955, won: 'bd eu lg' },
  { id: 'karlheinz_rummenigge', name: 'Karl-Heinz Rummenigge', nationality: 'Germany', positions: ['forward', 'striker'], clubs: ['Bayern Munich', 'Inter Milan'], debutYear: 1974, lastYear: 1989, birthYear: 1955, won: 'bd eu lg', aliases: ['Rummenigge'] },
  { id: 'paul_breitner', name: 'Paul Breitner', nationality: 'Germany', positions: ['defender', 'midfielder'], clubs: ['Bayern Munich', 'Real Madrid'], debutYear: 1970, lastYear: 1983, birthYear: 1951, won: 'cl wc lg', aliases: ['Breitner'] },
  { id: 'kevin_keegan', name: 'Kevin Keegan', nationality: 'England', positions: ['forward'], clubs: ['Liverpool', 'Hamburger SV', 'Southampton', 'Newcastle United'], debutYear: 1968, lastYear: 1984, birthYear: 1951, won: 'cl bd lg', aliases: ['Keegan'] },
  { id: 'bryan_robson', name: 'Bryan Robson', nationality: 'England', positions: ['midfielder'], clubs: ['West Bromwich Albion', 'Manchester United'], debutYear: 1974, lastYear: 1997, birthYear: 1957, won: 'lg' },
  { id: 'paul_gascoigne', name: 'Paul Gascoigne', nationality: 'England', positions: ['midfielder'], clubs: ['Newcastle United', 'Tottenham Hotspur', 'Lazio', 'Rangers', 'Middlesbrough'], debutYear: 1985, lastYear: 2004, birthYear: 1967, won: 'lg', aliases: ['Gazza', 'Gascoigne'] },
  { id: 'ian_rush', name: 'Ian Rush', nationality: 'Wales', positions: ['striker'], clubs: ['Liverpool', 'Juventus', 'Leeds United', 'Newcastle United'], debutYear: 1980, lastYear: 1999, birthYear: 1961, won: 'cl lg' },
  { id: 'john_barnes', name: 'John Barnes', nationality: 'England', positions: ['winger', 'midfielder'], clubs: ['Watford', 'Liverpool', 'Newcastle United'], debutYear: 1981, lastYear: 1999, birthYear: 1963, won: 'lg' },
  { id: 'gianluca_vialli', name: 'Gianluca Vialli', nationality: 'Italy', positions: ['striker'], clubs: ['Sampdoria', 'Juventus', 'Chelsea'], debutYear: 1984, lastYear: 1999, birthYear: 1964, won: 'cl lg', aliases: ['Vialli'] },
  { id: 'roberto_mancini', name: 'Roberto Mancini', nationality: 'Italy', positions: ['forward'], clubs: ['Bologna', 'Sampdoria', 'Lazio'], debutYear: 1981, lastYear: 2001, birthYear: 1964, won: 'lg', aliases: ['Mancini'] },
  { id: 'emilio_butragueno', name: 'Emilio Butragueño', nationality: 'Spain', positions: ['forward', 'striker'], clubs: ['Real Madrid'], debutYear: 1983, lastYear: 1998, birthYear: 1963, won: 'lg', aliases: ['Butragueño', 'Butragueno'] },
  { id: 'fernando_hierro', name: 'Fernando Hierro', nationality: 'Spain', positions: ['defender', 'midfielder'], clubs: ['Real Valladolid', 'Real Madrid', 'Bolton Wanderers'], debutYear: 1987, lastYear: 2005, birthYear: 1968, won: 'cl lg', aliases: ['Hierro'] },
  { id: 'fernando_morientes', name: 'Fernando Morientes', nationality: 'Spain', positions: ['striker'], clubs: ['Real Zaragoza', 'Real Madrid', 'Monaco', 'Liverpool', 'Valencia'], debutYear: 1993, lastYear: 2010, birthYear: 1976, won: 'cl lg', aliases: ['Morientes'] },
  { id: 'socrates', name: 'Sócrates', nationality: 'Brazil', positions: ['midfielder'], clubs: ['Corinthians', 'Fiorentina'], debutYear: 1974, lastYear: 1989, birthYear: 1954, won: '' },
  { id: 'bebeto', name: 'Bebeto', nationality: 'Brazil', positions: ['forward', 'striker'], clubs: ['Flamengo', 'Vasco da Gama', 'Deportivo La Coruña', 'Botafogo'], debutYear: 1983, lastYear: 2002, birthYear: 1964, won: 'wc' },
  { id: 'careca', name: 'Careca', nationality: 'Brazil', positions: ['striker'], clubs: ['São Paulo', 'Napoli'], debutYear: 1978, lastYear: 1994, birthYear: 1960, won: 'lg' },
  { id: 'rivelino', name: 'Rivelino', nationality: 'Brazil', positions: ['midfielder'], clubs: ['Corinthians', 'Fluminense'], debutYear: 1965, lastYear: 1981, birthYear: 1946, won: 'wc' },
  { id: 'carlos_alberto_torres', name: 'Carlos Alberto', nationality: 'Brazil', positions: ['defender'], clubs: ['Santos', 'Fluminense', 'Flamengo', 'New York Cosmos'], debutYear: 1963, lastYear: 1982, birthYear: 1944, won: 'wc', aliases: ['Carlos Alberto Torres'] },
  { id: 'jairzinho', name: 'Jairzinho', nationality: 'Brazil', positions: ['winger', 'forward'], clubs: ['Botafogo', 'Marseille'], debutYear: 1960, lastYear: 1982, birthYear: 1944, won: 'wc' },
  { id: 'juninho_pernambucano', name: 'Juninho Pernambucano', nationality: 'Brazil', positions: ['midfielder'], clubs: ['Vasco da Gama', 'Lyon'], debutYear: 1993, lastYear: 2013, birthYear: 1975, won: 'lg', aliases: ['Juninho'] },
  { id: 'rai_brazil', name: 'Rai', nationality: 'Brazil', positions: ['midfielder'], clubs: ['São Paulo', 'Paris Saint-Germain'], debutYear: 1987, lastYear: 2000, birthYear: 1965, won: 'wc lg' },
  { id: 'dunga', name: 'Dunga', nationality: 'Brazil', positions: ['midfielder'], clubs: ['Vasco da Gama', 'Fiorentina', 'Pescara', 'VfB Stuttgart'], debutYear: 1980, lastYear: 2000, birthYear: 1963, won: 'wc' },
  { id: 'taffarel', name: 'Taffarel', nationality: 'Brazil', positions: ['goalkeeper'], clubs: ['Internacional', 'Parma', 'Galatasaray'], debutYear: 1985, lastYear: 2003, birthYear: 1966, won: 'wc' },
  { id: 'mario_kempes', name: 'Mario Kempes', nationality: 'Argentina', positions: ['striker', 'forward'], clubs: ['Rosario Central', 'Valencia', 'River Plate'], debutYear: 1973, lastYear: 1996, birthYear: 1954, won: 'wc', aliases: ['Kempes'] },
  { id: 'daniel_passarella', name: 'Daniel Passarella', nationality: 'Argentina', positions: ['defender'], clubs: ['River Plate', 'Fiorentina', 'Inter Milan'], debutYear: 1974, lastYear: 1989, birthYear: 1953, won: 'wc', aliases: ['Passarella'] },
  { id: 'fernando_redondo', name: 'Fernando Redondo', nationality: 'Argentina', positions: ['midfielder'], clubs: ['Argentinos Juniors', 'Real Madrid', 'AC Milan'], debutYear: 1985, lastYear: 2004, birthYear: 1969, won: 'cl', aliases: ['Redondo'] },
  { id: 'claudio_caniggia', name: 'Claudio Caniggia', nationality: 'Argentina', positions: ['forward', 'striker'], clubs: ['River Plate', 'Atalanta', 'Roma', 'Benfica', 'Rangers'], debutYear: 1985, lastYear: 2004, birthYear: 1967, won: '', aliases: ['Caniggia'] },
  { id: 'ariel_ortega', name: 'Ariel Ortega', nationality: 'Argentina', positions: ['midfielder', 'forward'], clubs: ['River Plate', 'Valencia', 'Sampdoria', 'Parma'], debutYear: 1991, lastYear: 2012, birthYear: 1974, won: 'lg', aliases: ['Ortega'] },
  { id: 'gabriel_heinze', name: 'Gabriel Heinze', nationality: 'Argentina', positions: ['defender'], clubs: ['Vélez Sarsfield', 'Paris Saint-Germain', 'Manchester United', 'Real Madrid', 'Marseille', 'Roma'], debutYear: 1997, lastYear: 2014, birthYear: 1978, won: 'lg', aliases: ['Heinze'] },
  { id: 'enzo_francescoli', name: 'Enzo Francescoli', nationality: 'Uruguay', positions: ['forward', 'midfielder'], clubs: ['River Plate', 'Marseille', 'Torino', 'Cagliari'], debutYear: 1982, lastYear: 1997, birthYear: 1961, won: 'cp lg', aliases: ['Francescoli'] },
  { id: 'alvaro_recoba', name: 'Álvaro Recoba', nationality: 'Uruguay', positions: ['forward', 'midfielder'], clubs: ['Nacional', 'Inter Milan'], debutYear: 1994, lastYear: 2015, birthYear: 1976, won: '', aliases: ['Recoba'] },
  { id: 'faustino_asprilla', name: 'Faustino Asprilla', nationality: 'Colombia', positions: ['forward', 'striker'], clubs: ['Parma', 'Newcastle United', 'Palmeiras'], debutYear: 1988, lastYear: 2004, birthYear: 1969, won: '', aliases: ['Asprilla', 'Tino Asprilla'] },
  { id: 'roger_milla', name: 'Roger Milla', nationality: 'Cameroon', positions: ['striker', 'forward'], clubs: ['Monaco', 'Saint-Étienne', 'Montpellier'], debutYear: 1970, lastYear: 1994, birthYear: 1952, won: '', aliases: ['Milla'] },
  { id: 'abedi_pele', name: 'Abedi Pele', nationality: 'Ghana', positions: ['midfielder', 'forward'], clubs: ['Lille', 'Marseille', 'Lyon', 'Torino'], debutYear: 1982, lastYear: 2000, birthYear: 1964, won: 'cl lg', aliases: ['Abedi Ayew'] },

  /* ================= Expansion batch — modern ================= */
  { id: 'kai_havertz', name: 'Kai Havertz', nationality: 'Germany', positions: ['forward', 'midfielder'], clubs: ['Bayer Leverkusen', 'Chelsea', 'Arsenal'], debutYear: 2016, birthYear: 1999, won: 'cl', aliases: ['Havertz'] },
  { id: 'timo_werner', name: 'Timo Werner', nationality: 'Germany', positions: ['striker', 'forward'], clubs: ['VfB Stuttgart', 'RB Leipzig', 'Chelsea', 'Tottenham Hotspur'], debutYear: 2013, birthYear: 1996, won: 'cl', aliases: ['Werner'] },
  { id: 'julian_brandt', name: 'Julian Brandt', nationality: 'Germany', positions: ['midfielder', 'winger'], clubs: ['Bayer Leverkusen', 'Borussia Dortmund'], debutYear: 2014, birthYear: 1996, won: '', aliases: ['Brandt'] },
  { id: 'andre_onana', name: 'André Onana', nationality: 'Cameroon', positions: ['goalkeeper'], clubs: ['Ajax', 'Inter Milan', 'Manchester United'], debutYear: 2016, birthYear: 1996, won: 'lg', aliases: ['Onana'] },
  { id: 'jules_kounde', name: 'Jules Koundé', nationality: 'France', positions: ['defender'], clubs: ['Bordeaux', 'Sevilla', 'Barcelona'], debutYear: 2017, birthYear: 1998, won: 'lg', aliases: ['Koundé', 'Kounde'] },
  { id: 'marcus_thuram', name: 'Marcus Thuram', nationality: 'France', positions: ['forward', 'striker'], clubs: ['Sochaux', 'Borussia Mönchengladbach', 'Inter Milan'], debutYear: 2015, birthYear: 1997, won: 'lg' },
  { id: 'randal_kolo_muani', name: 'Randal Kolo Muani', nationality: 'France', positions: ['forward', 'striker'], clubs: ['Nantes', 'Eintracht Frankfurt', 'Paris Saint-Germain', 'Juventus'], debutYear: 2018, birthYear: 1998, won: 'lg', aliases: ['Kolo Muani'] },
  { id: 'adrien_rabiot', name: 'Adrien Rabiot', nationality: 'France', positions: ['midfielder'], clubs: ['Paris Saint-Germain', 'Juventus', 'Marseille'], debutYear: 2012, birthYear: 1995, won: 'lg', aliases: ['Rabiot'] },
  { id: 'benjamin_pavard', name: 'Benjamin Pavard', nationality: 'France', positions: ['defender'], clubs: ['Lille', 'VfB Stuttgart', 'Bayern Munich', 'Inter Milan'], debutYear: 2016, birthYear: 1996, won: 'cl wc lg', aliases: ['Pavard'] },
  { id: 'dayot_upamecano', name: 'Dayot Upamecano', nationality: 'France', positions: ['defender'], clubs: ['Red Bull Salzburg', 'RB Leipzig', 'Bayern Munich'], debutYear: 2015, birthYear: 1998, won: 'lg', aliases: ['Upamecano'] },
  { id: 'mike_maignan', name: 'Mike Maignan', nationality: 'France', positions: ['goalkeeper'], clubs: ['Paris Saint-Germain', 'Lille', 'AC Milan'], debutYear: 2013, birthYear: 1995, won: 'lg', aliases: ['Maignan'] },
  { id: 'josko_gvardiol', name: 'Joško Gvardiol', nationality: 'Croatia', positions: ['defender'], clubs: ['Dinamo Zagreb', 'RB Leipzig', 'Manchester City'], debutYear: 2020, birthYear: 2002, won: 'lg', aliases: ['Gvardiol'] },
  { id: 'dominik_szoboszlai', name: 'Dominik Szoboszlai', nationality: 'Hungary', positions: ['midfielder'], clubs: ['Red Bull Salzburg', 'RB Leipzig', 'Liverpool'], debutYear: 2018, birthYear: 2000, won: 'lg', aliases: ['Szoboszlai'] },
  { id: 'scott_mctominay', name: 'Scott McTominay', nationality: 'Scotland', positions: ['midfielder'], clubs: ['Manchester United', 'Napoli'], debutYear: 2017, birthYear: 1996, won: 'lg', aliases: ['McTominay'] },
  { id: 'james_maddison', name: 'James Maddison', nationality: 'England', positions: ['midfielder'], clubs: ['Norwich City', 'Leicester City', 'Tottenham Hotspur'], debutYear: 2015, birthYear: 1996, won: '', aliases: ['Maddison'] },
  { id: 'ademola_lookman', name: 'Ademola Lookman', nationality: 'Nigeria', positions: ['forward', 'winger'], clubs: ['Everton', 'RB Leipzig', 'Fulham', 'Leicester City', 'Atalanta'], debutYear: 2016, birthYear: 1997, won: '', aliases: ['Lookman'] },
  { id: 'sandro_tonali', name: 'Sandro Tonali', nationality: 'Italy', positions: ['midfielder'], clubs: ['Brescia', 'AC Milan', 'Newcastle United'], debutYear: 2018, birthYear: 2000, won: 'lg', aliases: ['Tonali'] },
  { id: 'gianluca_scamacca', name: 'Gianluca Scamacca', nationality: 'Italy', positions: ['striker'], clubs: ['Sassuolo', 'West Ham United', 'Atalanta'], debutYear: 2015, birthYear: 1999, won: '', aliases: ['Scamacca'] },
  { id: 'matheus_cunha', name: 'Matheus Cunha', nationality: 'Brazil', positions: ['forward', 'striker'], clubs: ['Hertha Berlin', 'Atlético Madrid', 'Wolverhampton Wanderers', 'Manchester United'], debutYear: 2017, birthYear: 1999, won: '', aliases: ['Cunha'] },
  { id: 'pedro_neto', name: 'Pedro Neto', nationality: 'Portugal', positions: ['winger', 'forward'], clubs: ['Braga', 'Lazio', 'Wolverhampton Wanderers', 'Chelsea'], debutYear: 2017, birthYear: 2000, won: '' },
  { id: 'ruben_neves', name: 'Rúben Neves', nationality: 'Portugal', positions: ['midfielder'], clubs: ['Porto', 'Wolverhampton Wanderers', 'Al Hilal'], debutYear: 2014, birthYear: 1997, won: '', aliases: ['Neves'] },
  { id: 'vitinha_pt', name: 'Vitinha', nationality: 'Portugal', positions: ['midfielder'], clubs: ['Porto', 'Wolverhampton Wanderers', 'Paris Saint-Germain'], debutYear: 2020, birthYear: 2000, won: 'cl lg' },
  { id: 'nuno_mendes', name: 'Nuno Mendes', nationality: 'Portugal', positions: ['defender'], clubs: ['Sporting CP', 'Paris Saint-Germain'], debutYear: 2020, birthYear: 2002, won: 'cl lg' },
  { id: 'joao_neves', name: 'João Neves', nationality: 'Portugal', positions: ['midfielder'], clubs: ['Benfica', 'Paris Saint-Germain'], debutYear: 2023, birthYear: 2004, won: 'cl lg' },
  { id: 'goncalo_ramos', name: 'Gonçalo Ramos', nationality: 'Portugal', positions: ['striker'], clubs: ['Benfica', 'Paris Saint-Germain'], debutYear: 2020, birthYear: 2001, won: 'cl lg', aliases: ['Ramos'] },
  { id: 'youssef_ennesyri', name: 'Youssef En-Nesyri', nationality: 'Morocco', positions: ['striker'], clubs: ['Málaga', 'Sevilla', 'Fenerbahçe'], debutYear: 2015, birthYear: 1997, won: '', aliases: ['En-Nesyri'] },
  { id: 'sofyan_amrabat', name: 'Sofyan Amrabat', nationality: 'Morocco', positions: ['midfielder'], clubs: ['Utrecht', 'Feyenoord', 'Club Brugge', 'Hellas Verona', 'Fiorentina', 'Manchester United'], debutYear: 2015, birthYear: 1996, won: '', aliases: ['Amrabat'] },
  { id: 'mohammed_kudus', name: 'Mohammed Kudus', nationality: 'Ghana', positions: ['midfielder', 'forward'], clubs: ['Ajax', 'West Ham United', 'Tottenham Hotspur'], debutYear: 2018, birthYear: 2000, won: '', aliases: ['Kudus'] },
  { id: 'thomas_partey', name: 'Thomas Partey', nationality: 'Ghana', positions: ['midfielder'], clubs: ['Atlético Madrid', 'Arsenal'], debutYear: 2013, birthYear: 1993, won: 'lg', aliases: ['Partey'] },
  { id: 'ivan_toney', name: 'Ivan Toney', nationality: 'England', positions: ['striker'], clubs: ['Newcastle United', 'Brentford', 'Al Ahli'], debutYear: 2014, birthYear: 1996, won: '', aliases: ['Toney'] },
  { id: 'ollie_watkins', name: 'Ollie Watkins', nationality: 'England', positions: ['forward', 'striker'], clubs: ['Brentford', 'Aston Villa'], debutYear: 2014, birthYear: 1995, won: '', aliases: ['Watkins'] },
  { id: 'eberechi_eze', name: 'Eberechi Eze', nationality: 'England', positions: ['midfielder', 'forward'], clubs: ['QPR', 'Crystal Palace', 'Arsenal'], debutYear: 2016, birthYear: 1998, won: '', aliases: ['Eze'] },
  { id: 'david_raya', name: 'David Raya', nationality: 'Spain', positions: ['goalkeeper'], clubs: ['Blackburn Rovers', 'Brentford', 'Arsenal'], debutYear: 2013, birthYear: 1995, won: '', aliases: ['Raya'] },
  { id: 'alexis_mac_allister', name: 'Alexis Mac Allister', nationality: 'Argentina', positions: ['midfielder'], clubs: ['Argentinos Juniors', 'Boca Juniors', 'Brighton', 'Liverpool'], debutYear: 2016, birthYear: 1998, won: 'wc lg', aliases: ['Mac Allister'] },
  { id: 'rodrigo_de_paul', name: 'Rodrigo De Paul', nationality: 'Argentina', positions: ['midfielder'], clubs: ['Racing Club', 'Valencia', 'Udinese', 'Atlético Madrid'], debutYear: 2012, birthYear: 1994, won: 'wc', aliases: ['De Paul'] },
  { id: 'nicolas_otamendi', name: 'Nicolás Otamendi', nationality: 'Argentina', positions: ['defender'], clubs: ['Vélez Sarsfield', 'Porto', 'Valencia', 'Manchester City', 'Benfica'], debutYear: 2007, birthYear: 1988, won: 'wc lg', aliases: ['Otamendi'] },
  { id: 'georginio_wijnaldum', name: 'Georginio Wijnaldum', nationality: 'Netherlands', positions: ['midfielder'], clubs: ['Feyenoord', 'PSV', 'Newcastle United', 'Liverpool', 'Paris Saint-Germain', 'Roma'], debutYear: 2007, birthYear: 1990, won: 'cl lg', aliases: ['Wijnaldum'] },
  { id: 'denzel_dumfries', name: 'Denzel Dumfries', nationality: 'Netherlands', positions: ['defender', 'winger'], clubs: ['Heerenveen', 'PSV', 'Inter Milan'], debutYear: 2014, birthYear: 1996, won: 'lg', aliases: ['Dumfries'] },
  { id: 'kobbie_mainoo', name: 'Kobbie Mainoo', nationality: 'England', positions: ['midfielder'], clubs: ['Manchester United'], debutYear: 2023, birthYear: 2005, won: '', aliases: ['Mainoo'] },

  // ---- Breadth batch: classic legends, under-covered nations/leagues, modern risers ----
  { id: 'hugo_sanchez', name: 'Hugo Sánchez', nationality: 'Mexico', positions: ['striker', 'forward'], clubs: ['Atlético Madrid', 'Real Madrid', 'Club América'], birthYear: 1958, debutYear: 1976, lastYear: 1997, won: 'lg', aliases: ['Sánchez', 'Sanchez'] },
  { id: 'michael_laudrup', name: 'Michael Laudrup', nationality: 'Denmark', positions: ['midfielder', 'forward'], clubs: ['Juventus', 'Barcelona', 'Real Madrid', 'Ajax'], birthYear: 1964, debutYear: 1981, lastYear: 1998, won: 'cl lg', aliases: ['Laudrup'] },
  { id: 'brian_laudrup', name: 'Brian Laudrup', nationality: 'Denmark', positions: ['winger', 'forward'], clubs: ['Fiorentina', 'AC Milan', 'Rangers', 'Chelsea'], birthYear: 1969, debutYear: 1986, lastYear: 2000, won: 'eu lg', aliases: ['Laudrup'] },
  { id: 'jean_pierre_papin', name: 'Jean-Pierre Papin', nationality: 'France', positions: ['striker', 'forward'], clubs: ['Marseille', 'AC Milan', 'Bordeaux', 'Bayern Munich'], birthYear: 1963, debutYear: 1984, lastYear: 1999, won: 'bd cl lg', aliases: ['Papin'] },
  { id: 'carlos_valderrama', name: 'Carlos Valderrama', nationality: 'Colombia', positions: ['midfielder'], clubs: ['Montpellier', 'Real Valladolid'], birthYear: 1961, debutYear: 1981, lastYear: 2002, won: '', aliases: ['Valderrama', 'El Pibe'] },
  { id: 'ivan_zamorano', name: 'Iván Zamorano', nationality: 'Chile', positions: ['striker', 'forward'], clubs: ['Sevilla', 'Real Madrid', 'Inter Milan'], birthYear: 1966, debutYear: 1985, lastYear: 2003, won: 'lg', aliases: ['Zamorano', 'Bam Bam'] },
  { id: 'giovane_elber', name: 'Giovane Élber', nationality: 'Brazil', positions: ['striker', 'forward'], clubs: ['VfB Stuttgart', 'Bayern Munich', 'Lyon'], birthYear: 1972, debutYear: 1990, lastYear: 2005, won: 'lg', aliases: ['Élber', 'Elber'] },
  { id: 'harry_kewell', name: 'Harry Kewell', nationality: 'Australia', positions: ['winger', 'forward'], clubs: ['Leeds United', 'Liverpool', 'Galatasaray'], birthYear: 1978, debutYear: 1996, lastYear: 2014, won: 'cl lg', aliases: ['Kewell'] },
  { id: 'robert_pires', name: 'Robert Pirès', nationality: 'France', positions: ['winger', 'midfielder'], clubs: ['Metz', 'Marseille', 'Arsenal', 'Villarreal'], birthYear: 1973, debutYear: 1993, lastYear: 2015, won: 'wc eu lg', aliases: ['Pirès', 'Pires'] },
  { id: 'emmanuel_petit', name: 'Emmanuel Petit', nationality: 'France', positions: ['midfielder', 'defender'], clubs: ['Monaco', 'Arsenal', 'Barcelona', 'Chelsea'], birthYear: 1970, debutYear: 1989, lastYear: 2005, won: 'wc eu lg', aliases: ['Petit'] },
  { id: 'freddie_ljungberg', name: 'Freddie Ljungberg', nationality: 'Sweden', positions: ['winger', 'midfielder'], clubs: ['Arsenal', 'West Ham United'], birthYear: 1977, debutYear: 1994, lastYear: 2012, won: 'lg', aliases: ['Ljungberg'] },
  { id: 'youri_djorkaeff', name: 'Youri Djorkaeff', nationality: 'France', positions: ['forward', 'midfielder'], clubs: ['Monaco', 'Paris Saint-Germain', 'Inter Milan', 'Kaiserslautern', 'Bolton Wanderers'], birthYear: 1968, debutYear: 1989, lastYear: 2006, won: 'wc eu', aliases: ['Djorkaeff'] },
  { id: 'rafael_van_der_vaart', name: 'Rafael van der Vaart', nationality: 'Netherlands', positions: ['midfielder'], clubs: ['Ajax', 'Hamburger SV', 'Real Madrid', 'Tottenham Hotspur', 'Real Betis'], birthYear: 1983, debutYear: 2000, lastYear: 2018, won: 'lg', aliases: ['van der Vaart'] },
  { id: 'klaas_jan_huntelaar', name: 'Klaas-Jan Huntelaar', nationality: 'Netherlands', positions: ['striker'], clubs: ['Heerenveen', 'Ajax', 'Real Madrid', 'AC Milan', 'Schalke 04'], birthYear: 1983, debutYear: 2002, lastYear: 2021, won: 'lg', aliases: ['Huntelaar'] },
  { id: 'mark_van_bommel', name: 'Mark van Bommel', nationality: 'Netherlands', positions: ['midfielder'], clubs: ['PSV', 'Barcelona', 'Bayern Munich', 'AC Milan'], birthYear: 1977, debutYear: 1995, lastYear: 2013, won: 'cl lg', aliases: ['van Bommel'] },
  { id: 'nigel_de_jong', name: 'Nigel de Jong', nationality: 'Netherlands', positions: ['midfielder'], clubs: ['Ajax', 'Hamburger SV', 'Manchester City', 'AC Milan', 'LA Galaxy'], birthYear: 1984, debutYear: 2002, lastYear: 2021, won: 'lg', aliases: ['de Jong'] },
  { id: 'esteban_cambiasso', name: 'Esteban Cambiasso', nationality: 'Argentina', positions: ['midfielder'], clubs: ['Independiente', 'Real Madrid', 'Inter Milan', 'Leicester City'], birthYear: 1980, debutYear: 1998, lastYear: 2017, won: 'cl lg', aliases: ['Cambiasso'] },
  { id: 'walter_samuel', name: 'Walter Samuel', nationality: 'Argentina', positions: ['defender'], clubs: ['Boca Juniors', 'Roma', 'Real Madrid', 'Inter Milan'], birthYear: 1978, debutYear: 1997, lastYear: 2016, won: 'cl lg', aliases: ['Samuel'] },
  { id: 'pablo_aimar', name: 'Pablo Aimar', nationality: 'Argentina', positions: ['midfielder'], clubs: ['River Plate', 'Valencia', 'Real Zaragoza', 'Benfica'], birthYear: 1979, debutYear: 1996, lastYear: 2015, won: 'lg', aliases: ['Aimar'] },
  { id: 'marcelo_salas', name: 'Marcelo Salas', nationality: 'Chile', positions: ['striker', 'forward'], clubs: ['River Plate', 'Lazio', 'Juventus'], birthYear: 1974, debutYear: 1993, lastYear: 2008, won: 'lg', aliases: ['Salas'] },
  { id: 'ivan_cordoba', name: 'Iván Córdoba', nationality: 'Colombia', positions: ['defender'], clubs: ['San Lorenzo', 'Inter Milan'], birthYear: 1976, debutYear: 1994, lastYear: 2012, won: 'cl lg', aliases: ['Córdoba', 'Cordoba'] },
  { id: 'rene_higuita', name: 'René Higuita', nationality: 'Colombia', positions: ['goalkeeper'], clubs: ['Atlético Nacional'], birthYear: 1966, debutYear: 1985, lastYear: 2010, won: '', aliases: ['Higuita', 'El Loco'] },
  { id: 'frederic_kanoute', name: 'Frédéric Kanouté', nationality: 'Mali', positions: ['striker', 'forward'], clubs: ['Lyon', 'West Ham United', 'Tottenham Hotspur', 'Sevilla'], birthYear: 1977, debutYear: 1997, lastYear: 2013, won: '', aliases: ['Kanouté', 'Kanoute'] },
  { id: 'el_hadji_diouf', name: 'El Hadji Diouf', nationality: 'Senegal', positions: ['forward', 'winger'], clubs: ['Sochaux', 'Lens', 'Liverpool', 'Bolton Wanderers', 'Rangers'], birthYear: 1981, debutYear: 1998, lastYear: 2015, won: 'lg', aliases: ['Diouf'] },
  { id: 'emmanuel_adebayor', name: 'Emmanuel Adebayor', nationality: 'Togo', positions: ['striker', 'forward'], clubs: ['Monaco', 'Arsenal', 'Manchester City', 'Real Madrid', 'Tottenham Hotspur'], birthYear: 1984, debutYear: 2001, lastYear: 2017, won: '', aliases: ['Adebayor'] },
  { id: 'asamoah_gyan', name: 'Asamoah Gyan', nationality: 'Ghana', positions: ['striker', 'forward'], clubs: ['Udinese', 'Rennes', 'Sunderland'], birthYear: 1985, debutYear: 2003, lastYear: 2018, won: '', aliases: ['Gyan'] },
  { id: 'kolo_toure', name: 'Kolo Touré', nationality: 'Ivory Coast', positions: ['defender'], clubs: ['Arsenal', 'Manchester City', 'Liverpool', 'Celtic'], birthYear: 1981, debutYear: 2000, lastYear: 2017, won: 'lg', aliases: ['Touré', 'Toure'] },
  { id: 'alphonso_davies', name: 'Alphonso Davies', nationality: 'Canada', positions: ['defender', 'winger'], clubs: ['Vancouver Whitecaps', 'Bayern Munich'], birthYear: 2000, debutYear: 2016, won: 'cl lg', aliases: ['Davies'] },
  { id: 'weston_mckennie', name: 'Weston McKennie', nationality: 'United States', positions: ['midfielder'], clubs: ['Schalke 04', 'Juventus', 'Leeds United'], birthYear: 1998, debutYear: 2016, won: 'lg', aliases: ['McKennie'] },
  { id: 'landon_donovan', name: 'Landon Donovan', nationality: 'United States', positions: ['forward', 'midfielder'], clubs: ['Bayer Leverkusen', 'LA Galaxy', 'Everton'], birthYear: 1982, debutYear: 2000, lastYear: 2018, won: '', aliases: ['Donovan'] },
  { id: 'clint_dempsey', name: 'Clint Dempsey', nationality: 'United States', positions: ['forward', 'midfielder'], clubs: ['Fulham', 'Tottenham Hotspur', 'Seattle Sounders'], birthYear: 1983, debutYear: 2004, lastYear: 2018, won: '', aliases: ['Dempsey'] },
  { id: 'gabriel_martinelli', name: 'Gabriel Martinelli', nationality: 'Brazil', positions: ['winger', 'forward'], clubs: ['Arsenal'], birthYear: 2001, debutYear: 2017, won: '', aliases: ['Martinelli'] },
  { id: 'takefusa_kubo', name: 'Takefusa Kubo', nationality: 'Japan', positions: ['winger', 'midfielder'], clubs: ['Real Madrid', 'Mallorca', 'Real Sociedad'], birthYear: 2001, debutYear: 2018, won: '', aliases: ['Kubo'] },
  { id: 'kaoru_mitoma', name: 'Kaoru Mitoma', nationality: 'Japan', positions: ['winger', 'forward'], clubs: ['Brighton'], birthYear: 1997, debutYear: 2020, won: '', aliases: ['Mitoma'] },
  { id: 'mehdi_taremi', name: 'Mehdi Taremi', nationality: 'Iran', positions: ['striker', 'forward'], clubs: ['Porto', 'Inter Milan'], birthYear: 1992, debutYear: 2013, won: 'lg', aliases: ['Taremi'] },
  { id: 'serhou_guirassy', name: 'Serhou Guirassy', nationality: 'Guinea', positions: ['striker'], clubs: ['Rennes', 'VfB Stuttgart', 'Borussia Dortmund'], birthYear: 1996, debutYear: 2015, won: '', aliases: ['Guirassy'] },
  { id: 'jonathan_david', name: 'Jonathan David', nationality: 'Canada', positions: ['striker', 'forward'], clubs: ['Gent', 'Lille', 'Juventus'], birthYear: 2000, debutYear: 2018, won: 'lg', aliases: ['David'] },
  { id: 'benjamin_sesko', name: 'Benjamin Šeško', nationality: 'Slovenia', positions: ['striker'], clubs: ['Red Bull Salzburg', 'RB Leipzig', 'Manchester United'], birthYear: 2003, debutYear: 2020, won: 'lg', aliases: ['Šeško', 'Sesko'] },
  { id: 'lois_openda', name: 'Loïs Openda', nationality: 'Belgium', positions: ['forward', 'striker'], clubs: ['Club Brugge', 'Lens', 'RB Leipzig', 'Juventus'], birthYear: 2000, debutYear: 2018, won: '', aliases: ['Openda'] },
  { id: 'rasmus_hojlund', name: 'Rasmus Højlund', nationality: 'Denmark', positions: ['striker'], clubs: ['Atalanta', 'Manchester United', 'Napoli'], birthYear: 2003, debutYear: 2020, won: '', aliases: ['Højlund', 'Hojlund'] },
  { id: 'xavi_simons', name: 'Xavi Simons', nationality: 'Netherlands', positions: ['midfielder', 'forward'], clubs: ['PSV', 'Paris Saint-Germain', 'RB Leipzig', 'Tottenham Hotspur'], birthYear: 2003, debutYear: 2022, won: 'lg', aliases: ['Simons'] },
  { id: 'michael_olise', name: 'Michael Olise', nationality: 'France', positions: ['winger', 'midfielder'], clubs: ['Crystal Palace', 'Bayern Munich'], birthYear: 2001, debutYear: 2019, won: 'lg', aliases: ['Olise'] },
  { id: 'joao_palhinha', name: 'João Palhinha', nationality: 'Portugal', positions: ['midfielder'], clubs: ['Sporting CP', 'Braga', 'Fulham', 'Bayern Munich'], birthYear: 1995, debutYear: 2013, won: 'lg', aliases: ['Palhinha'] },
  { id: 'giovani_lo_celso', name: 'Giovani Lo Celso', nationality: 'Argentina', positions: ['midfielder'], clubs: ['Rosario Central', 'Paris Saint-Germain', 'Tottenham Hotspur', 'Real Betis'], birthYear: 1996, debutYear: 2015, won: 'wc lg', aliases: ['Lo Celso'] },
  { id: 'joshua_zirkzee', name: 'Joshua Zirkzee', nationality: 'Netherlands', positions: ['striker', 'forward'], clubs: ['Bayern Munich', 'Bologna', 'Manchester United'], birthYear: 2001, debutYear: 2019, won: 'lg', aliases: ['Zirkzee'] },
  { id: 'wataru_endo', name: 'Wataru Endō', nationality: 'Japan', positions: ['midfielder'], clubs: ['VfB Stuttgart', 'Liverpool'], birthYear: 1993, debutYear: 2015, won: 'lg', aliases: ['Endō', 'Endo'] },
  { id: 'keisuke_honda', name: 'Keisuke Honda', nationality: 'Japan', positions: ['midfielder', 'forward'], clubs: ['CSKA Moscow', 'AC Milan'], birthYear: 1986, debutYear: 2005, lastYear: 2023, won: 'lg', aliases: ['Honda'] },
  { id: 'mark_viduka', name: 'Mark Viduka', nationality: 'Australia', positions: ['striker', 'forward'], clubs: ['Celtic', 'Leeds United', 'Middlesbrough', 'Newcastle United'], birthYear: 1975, debutYear: 1993, lastYear: 2009, won: 'lg', aliases: ['Viduka'] },
  { id: 'hakan_sukur', name: 'Hakan Şükür', nationality: 'Turkey', positions: ['striker', 'forward'], clubs: ['Galatasaray', 'Inter Milan', 'Parma', 'Blackburn Rovers'], birthYear: 1971, debutYear: 1990, lastYear: 2008, won: 'lg', aliases: ['Şükür', 'Sukur'] },
  { id: 'lucas_moura', name: 'Lucas Moura', nationality: 'Brazil', positions: ['winger', 'forward'], clubs: ['São Paulo', 'Paris Saint-Germain', 'Tottenham Hotspur'], birthYear: 1992, debutYear: 2010, won: 'lg', aliases: ['Moura'] },
];
