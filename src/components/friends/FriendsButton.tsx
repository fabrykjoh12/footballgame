  ...
  return (
    <>
      <button
        ...
        aria-label="Friends"
        title="Friends"
        className="answer-press flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-2 text-white/70 hover:bg-white/[0.05] hover:text-white"
      >
...
function FriendsModal({ onClose }: { onClose: () => void }) {
  ...
  return createPortal(
    ...
    >
      <div
        className="relative w-full max-w-sm rounded-2xl border border-white/10 bg-ink-800 p-6 shadow-elev-2 animate-scale-in"
      ...
      >
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute right-3 top-3 rounded-full p-1.5 text-white/55 hover:bg-white/[0.05] hover:text-white"
        >
        ...
        <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.03] p-3 text-center">
          <div className="text-[11px] text-white/55">Your friend code</div>
            ...
            <>
              ...
              {tab === 'search' ? (
                <div className="flex flex-col gap-2">
                  ...
                  />
                  {searching && (
                    <p className="text-center text-xs text-white/55">Searching…</p>
                  )}
                  {!searching && query.length >= 2 && searchResults.length === 0 && (
                    <p className="text-center text-xs text-white/55">No players found.</p>
                  )}
              ...
              {friends.map((f) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-full p-1.5 text-white/40 hover:bg-white/[0.05] hover:text-danger"
                  >
                    <IconClose className="h-4 w-4" />
                  </button>
                </li>
        ...
        {recent.length > 0 && (
          <div className="mt-4">
            <h3 className="mb-2 text-[11px] font-semibold text-white/55">
              Recent opponents
            </h3>
              ...
              {recent.map((o) => {
                ...
                return (
                  <li
                    ...
                    className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2"
                  >
                    <span className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-white/[0.05] text-sm font-bold text-white/65">
