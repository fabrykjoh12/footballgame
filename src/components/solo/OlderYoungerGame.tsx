...
export function OlderYoungerGame({ onExit }: { onExit: () => void }) {
  ...
  if (phase === 'over') {
    ...
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-5 py-10 text-center animate-fade-in">
        ...
        <div>
          <div className="text-xs font-bold text-white/55">Older or Younger?</div>
  ...
  if (!round) {
    return (
      <div className="flex flex-1 items-center justify-center py-20 text-white/55">
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 py-4 animate-fade-in">
      ...
      {revealing ? (
        ...
        <p className="text-center text-xs text-white/55">Is the next player older or younger?</p>
      )}
    ...
    <Card strong className="flex items-center justify-between gap-3 p-4">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          {club && <div className="truncate text-xs text-white/55">{club}</div>}
        </div>
      </div>
      <div className="shrink-0 text-right">
        <div className="text-[11px] text-white/55">Born</div>
