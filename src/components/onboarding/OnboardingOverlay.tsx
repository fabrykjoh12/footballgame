...
export function OnboardingOverlay({
  ...
  const body = (
    ...
    >
      <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-ink-800 p-6 text-center shadow-elev-2 animate-scale-in">
        <button
          type="button"
          onClick={() => finish()}
          className="ml-auto block text-xs text-white/55 hover:text-white"
        >
          Skip
        </button>
        ...
        <p className="mx-auto mt-2 max-w-xs text-balance text-sm text-white/65">{s.body}</p>
