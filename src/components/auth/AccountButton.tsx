        ...
        {user && needsUsername ? (
          ...
          <div>
            ...
            <label
              ...
              className="mb-1.5 mt-3 block text-xs font-semibold text-white/55"
            >
              Password
            </label>
            <input
            ...
            <button
              ...
              className="w-full text-center text-xs text-white/55 hover:text-pitch disabled:opacity-40"
            >
