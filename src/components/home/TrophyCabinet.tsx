...
function ModalShell({
  ...
  return createPortal(
    ...
    >
      <div
        className="relative w-full max-w-md rounded-2xl border border-white/10 bg-ink-800 p-6 shadow-elev-2 animate-scale-in"
        ...
        {list.map((a) => (
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="block text-xs text-white/55">{a.description}</span>
            </span>
...
function LeaderboardModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <ModalShell title="Leaderboard" onClose={onClose}>
      ...
      <p className="mb-3 text-center text-[11px] text-white/55">{boardLabel(board)}</p>
