...
pass, and **296 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (296 tests across lib/, data/, services/)
```
...
`npm test` runs **296 tests** across 33 files: `scoring` (incl. **`guessAccuracy` +
