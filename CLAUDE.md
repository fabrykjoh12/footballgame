...
pass, and **318 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (318 tests across lib/, data/, services/)
```
...
`npm test` runs **318 tests** across 36 files: `scoring` (incl. **`guessAccuracy` +
