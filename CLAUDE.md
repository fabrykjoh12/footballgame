...
pass, and **330 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (330 tests across lib/, data/, services/)
```
...
`npm test` runs **330 tests** across 38 files: `scoring` (incl. **`guessAccuracy` +
