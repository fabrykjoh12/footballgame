...
pass, and **255 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (255 tests across lib/, data/, services/)
```
...
`npm test` runs **255 tests** across 28 files: `scoring` (incl. **`guessAccuracy` +
