...
pass, and **241 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (241 tests across lib/, data/, services/)
```
...
`npm test` runs **241 tests** across 27 files: `scoring` (incl. **`guessAccuracy` +
