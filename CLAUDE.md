...
pass, and **337 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (337 tests across lib/, data/, services/)
```
...
`npm test` runs **337 tests** across 39 files: `scoring` (incl. **`guessAccuracy` +
