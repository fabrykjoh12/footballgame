...
pass, and **287 unit tests** gating an auto-deploy pipeline.
...
npm test         # vitest run (287 tests across lib/, data/, services/)
```
...
`npm test` runs **287 tests** across 31 files: `scoring` (incl. **`guessAccuracy` +
