...
> `src/data/managers.ts` + `src/lib/playerDb.ts` — **583 curated players** (stable
...
| **Central player database** (583 players, stable facts incl. birthYear) + canonical club registry (228 clubs, alias resolution) + pure query layer (playedForBoth, byNationality/Position/League, careerChain, cluesFor) | `src/data/players.ts`, `src/data/clubs.ts`, `src/lib/playerDb.ts` |
